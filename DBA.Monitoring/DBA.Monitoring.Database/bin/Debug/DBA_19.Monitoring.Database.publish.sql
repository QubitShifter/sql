...
BEGIN TRANSACTION
GO
PRINT N'Creating Table [dbo].[QueryStoreExpensiveQueryHistory]...';
...
CREATE TABLE [dbo].[QueryStoreExpensiveQueryHistory] (
    ...
    CONSTRAINT [PK_QueryStoreExpensiveQueryHistory] PRIMARY KEY CLUSTERED ([QueryStoreExpensiveQueryHistoryID] ASC)
);
...
GO
PRINT N'Creating Index [dbo].[QueryStoreExpensiveQueryHistory].[IX_QueryStoreExpensiveQueryHistory_CollectionTime]...';


GO
CREATE NONCLUSTERED INDEX [IX_QueryStoreExpensiveQueryHistory_CollectionTime]
...
GO
PRINT N'Creating Index [dbo].[QueryStoreExpensiveQueryHistory].[IX_QueryStoreExpensiveQueryHistory_DatabaseName_CollectionTime]...';


GO
CREATE NONCLUSTERED INDEX [IX_QueryStoreExpensiveQueryHistory_DatabaseName_CollectionTime]
    ON [dbo].[QueryStoreExpensiveQueryHistory]([DatabaseName] ASC, [CollectionTime] DESC)
    INCLUDE([QueryID], [PlanID], [ExecutionCount], [TotalCpuMs], [TotalDurationMs], [TotalLogicalReads], [LastExecutionTime]);
...
GO
PRINT N'Creating Index [dbo].[QueryStoreExpensiveQueryHistory].[IX_QueryStoreExpensiveQueryHistory_TotalCpuMs]...';


GO
CREATE NONCLUSTERED INDEX [IX_QueryStoreExpensiveQueryHistory_TotalCpuMs]
...
GO
PRINT N'Creating Default Constraint [dbo].[DF_QueryStoreExpensiveQueryHistory_CollectionTime]...';


GO
ALTER TABLE [dbo].[QueryStoreExpensiveQueryHistory]
    ADD CONSTRAINT [DF_QueryStoreExpensiveQueryHistory_CollectionTime] DEFAULT (sysdatetime()) FOR [CollectionTime];
...
GO
PRINT N'Creating Procedure [dbo].[CollectQueryStoreExpensiveQueries]...';
