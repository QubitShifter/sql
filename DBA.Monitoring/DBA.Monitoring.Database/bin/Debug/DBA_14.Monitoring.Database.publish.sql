...
BEGIN TRANSACTION
GO
PRINT N'Creating View [dbo].[vBlitzLatestFindings]...';
...
GO
PRINT N'Creating View [dbo].[vBlitzCriticalFindings]...';
...
GO
PRINT N'Creating View [dbo].[vBlitzFindingSummary]...';
...
select
    ...
    WarningFindings =
        sum(case when [Priority] between 51 and 150 then 1 else 0 end),

    InformationalFindings =
        sum(case when [Priority] between 151 and 250 then 1 else 0 end),
