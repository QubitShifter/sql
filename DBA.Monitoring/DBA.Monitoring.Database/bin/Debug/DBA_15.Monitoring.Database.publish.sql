...
BEGIN TRANSACTION
GO
PRINT N'Altering View [dbo].[vBlitzFindingSummary]...';


GO
ALTER view [dbo].[vBlitzFindingSummary]
as
select
    [CheckDate],
...
GO
PRINT N'Creating View [dbo].[vBlitzDashboardFindings]...';
...
GO
PRINT N'Altering Procedure [dbo].[CollectBlitzHealthChecks]...';


GO
ALTER procedure [dbo].[CollectBlitzHealthChecks]
